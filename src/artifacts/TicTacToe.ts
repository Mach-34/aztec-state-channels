...
export class TicTacToeContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** get_board(game_id: field) */
    get_board: ((game_id: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** turn(index: field, row: integer, col: integer) */
    turn: ((index: FieldLike, row: (bigint | number), col: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
  };
}
