...
export class TicTacToeContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** dispute_timeout(game_id: field, turn_index: integer, signature: array, sender: field, move: array) */
    dispute_timeout: ((game_id: FieldLike, turn_index: (bigint | number), signature: (bigint | number)[], sender: FieldLike, move: (bigint | number)[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
