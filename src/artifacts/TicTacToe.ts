...
export class TicTacToeContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** orchestrator(host: field, challenger: field, host_signature: array, challenger_signature: array, game_id: field) */
    orchestrator: ((host: FieldLike, challenger: FieldLike, host_signature: (bigint | number)[], challenger_signature: (bigint | number)[], game_id: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
